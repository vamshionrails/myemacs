...
(setq default-directory "/Volumes/macHD/www/nginx/projects/ROR/development")
...
(set-background-color "#ECF4FD")
(set-foreground-color "black")
(set-face-background 'modeline "aquamarine2")
...
(custom-set-variables
 ...
 '(ecb-layout-window-sizes (quote (("left13" (ecb-directories-buffer-name 0.19662921348314608 . 0.98)) ("left8" (ecb-directories-buffer-name 0.23671497584541062 . 0.29310344827586204) (ecb-sources-buffer-name 0.23671497584541062 . 0.22413793103448276) (ecb-methods-buffer-name 0.23671497584541062 . 0.25862068965517243) (ecb-history-buffer-name 0.23671497584541062 . 0.20689655172413793)))))
 '(ecb-options-version "2.40")
 '(ecb-source-path (quote (("/" "/") ("/Volumes/macHD/www/nginx/projects/ROR/development/TravelCLICK_istay3" "TravelClick"))))
 '(quote (frame-background-mode (quote dark))))
...
;; snippet
(load "~/.emacs.d/plugins/snippet.el")
...
(require 'rails)
;;Rspec
(load "~/.emacs.d/plugins/rspec-mode/rspec-mode.el")


;;haml
(load "~/.emacs.d/plugins/haml-mode/haml-mode.el")
